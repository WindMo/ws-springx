...
public class SecurityKeyUtils {
    ...
    public static boolean matchKeys(String algorithm, PublicKey publicKey, PrivateKey privateKey) {
        ...
        try {
            ...
            byte[] plainBytes = SecurityKeyUtils.class.getName().getBytes(StandardCharsets.UTF_8);
            ...
            return Arrays.equals(plainBytes, decryptedBytes);
        } catch (Exception e) {
            throw new UnsupportedOperationException("Unable to match", e);
        }
    }
