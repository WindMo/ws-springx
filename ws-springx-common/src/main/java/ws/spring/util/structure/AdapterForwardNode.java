...
class AdapterForwardNode<E, K> extends BasicTreeNode<E> implements ForwardNode<K> {
    ...
    public AdapterForwardNode(E value, Collection<WritableTreeNode<E>> children, Function<? super E, ? extends K> keyMapping, Function<? super E, ? extends K> parentKeyMapping) {
