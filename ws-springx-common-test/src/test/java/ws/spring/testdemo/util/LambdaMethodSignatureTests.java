...
import ws.spring.util.lambda.IllegalMethodSignature;
...
public class LambdaMethodSignatureTests {
    ...
    void parsePrimitiveTypeSignatureClassTest() {
        ...
        Exception e;
        e = Assertions.assertThrows(IllegalMethodSignature.class, () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, 'P'));
    ...
    void parseTypeSignatureClassTest() {
        ...
        e = Assertions.assertThrows(IllegalMethodSignature.class, () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, "P"));
        log.info("IllegalMethodSignature: {}", e.getMessage());
        e = Assertions.assertThrows(IllegalMethodSignature.class, () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, "abc"));
        log.info("IllegalMethodSignature: {}", e.getMessage());
        e = Assertions.assertThrows(IllegalMethodSignature.class, () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, invokeSignType(String.class) + ";"));
    ...
    void parseMethodSignatureTest() {
        ...
        Exception e;
        e = Assertions.assertThrows(IllegalMethodSignature.class , () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, "(V)V"));
        log.info("IllegalMethodSignature: {}", e.getMessage());

        e = Assertions.assertThrows(IllegalMethodSignature.class , () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, "(Ljava/lang/Integer)Ljava/lang/Integer;"));
        log.info("IllegalMethodSignature: {}", e.getMessage());

        e = Assertions.assertThrows(IllegalMethodSignature.class , () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, "(L;)Ljava/lang/Integer;"));
        log.info("IllegalMethodSignature: {}", e.getMessage());

        e = Assertions.assertThrows(IllegalMethodSignature.class , () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, "()V;"));
        log.info("IllegalMethodSignature: {}", e.getMessage());

        e = Assertions.assertThrows(IllegalMethodSignature.class , () -> ReflectionTestUtils.invokeMethod(MAIN_CLASS, method, "()"));
        log.info("IllegalMethodSignature: {}", e.getMessage());
    }
